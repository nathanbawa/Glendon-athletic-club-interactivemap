document.addEventListener('DOMContentLoaded', () => {
  ...
  // Left-click drag = grab and pan, scroll = zoom
  // ─────────────────────────────────────────
  ...
  // Show grab cursor on hover to indicate the map is draggable
  if (isDesktop()) {
  ...
  mv.addEventListener('pointermove', (e) => {
    ...
    // Pan in all directions - grab and drag like mobile
    const target = mv.getCameraTarget();
    
    // Higher sensitivity for smooth, responsive dragging like mobile
    const PAN_SENSITIVITY = 0.35;
